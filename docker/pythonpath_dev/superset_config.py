...
# Use environment variable for SECRET_KEY to avoid decryption issues
# SECRET_KEY should be set via environment variables in docker/.env
GUEST_TOKEN_JWT_EXP_SECONDS = 864000 #10 days
CORS_OPTIONS = {
